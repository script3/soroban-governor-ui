  ...
  return (
    <div className="mb-5 px-4 md:px-0">
      <div className="flex flex-col space-y-3">
        ...
        >
          <div className=" min-h-[240px] overflow-hidden p-2 rounded-t-xl border focus-within:border-skin-text outline-none">
            <textarea
              ref={textAreaEl}
              value={value}
          ...
          <label className="relative flex items-center justify-between rounded-b-xl border border-t-0 border-skin-border px-2 py-1 peer-focus-within:border-skin-text">
            <input
